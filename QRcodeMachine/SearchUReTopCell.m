...
@implementation SearchUReTopCell
...
- (UIButton *)makeSureBtn{
    if(!_makeSureBtn){
        ...
        [_makeSureBtn setTitle:@"Load current link" forState:UIControlStateNormal];
...
- (UILabel *)tLabel{
    if(!_tLabel){
        ...
        _tLabel.text = @"The links scanned are:";
...
- (void)makeAction:(UIButton *)sender{
    if(self.visLineBlock){
        self.visLineBlock(self.model.extra[@"link"]);
    }
}
@end
