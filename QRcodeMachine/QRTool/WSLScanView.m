...
- (void)drawRect:(CGRect)rect{
    ...
    [myCode setTitle:@"" forState:UIControlStateNormal];
    [myCode setTitleColor:MainColor forState:UIControlStateNormal];
...
- (UIView *)handlingView{
    ...
    if (_handlingView == nil) {
        ...
        handleLabel.textColor = MainColor;
